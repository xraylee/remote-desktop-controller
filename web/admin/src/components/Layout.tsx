    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <aside className="hidden w-64 flex-col border-r border-gray-200 bg-white lg:flex">
        ...
        <div className="flex h-16 items-center gap-2 border-b border-gray-200 px-6">
          ...
          <span className="text-lg font-semibold text-gray-900">RDCS Admin</span>
        </div>
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <header className="flex h-16 items-center justify-between border-b border-gray-200 bg-white px-4 lg:px-8">
          <h2 className="text-lg font-semibold text-gray-900 lg:hidden">RDCS Admin</h2>
          <div className="hidden lg:block" /> {/* spacer for alignment */}
          <button
            type="button"
            onClick={handleLogout}
            className="rounded-lg px-3 py-1.5 text-sm text-gray-600 hover:bg-gray-100 lg:hidden"
          >
            退出
          </button>
        </header>
