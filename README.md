...
- **Apple Silicon** (M1/M2/M3/M4): [Download arm64 version](https://github.com/your-org/rdcs/releases/latest/download/rdcs_client-arm64-latest.dmg)
- **Intel Mac**: [Download x86_64 version](https://github.com/your-org/rdcs/releases/latest/download/rdcs_client-x86_64-latest.dmg)

Not sure which Mac you have? Run this in Terminal:
...
For detailed build instructions across architectures, see the [Multi-Architecture Build Guide](docs/BUILD_MULTI_ARCH.md).
...
# 2. Development build (auto-detects architecture)
cd client/flutter
flutter run -d macos

# 3. Release build (explicit architecture)
flutter build macos --release --target-arch=arm64  # or x64
cd ../..
./scripts/package_macos.sh arm64  # or x64
```
...
| Phase 1: Network Connection (ICE/DTLS) | ✅ Complete | Jun 2026 |
| Phase 2: Video Streaming | ✅ Complete | Jun 2026 |
| Phase 3: Input Control | ✅ Complete | Jun 2026 |
| Phase 4: Client Testing (TDD) | 🔄 In Progress (54%) ⭐ | Jun-Jul 2026 |
| MVP: Remote Desktop (macOS) | 📋 Planned | Jul-Aug 2026 |

> **Current focus**: Client TDD testing — 3/14 components verified (ConfigRepository, SignalingService, WebSocketClient). Test coverage: ~77% average.  
> See [Test Documentation](client/flutter/test/README.md) for details.

### Documentation

- **[MVP Definition](docs/MVP.md)** — What we're building and when
- **[Current Phase](docs/CURRENT_PHASE.md)** — Where we are right now
- **[E2E Test Plan](docs/E2E_TEST_PLAN.md)** — End-to-end testing strategy
- [Documentation Index](docs/README.md) — Complete documentation navigation
- [Project Structure](PROJECT_STRUCTURE.md) — Project organization and directory structure
...
|------|------|------|
| 市场研究与分析 | ✅ 完成 | 2026 Q2 |
| Phase 1: 网络连接（ICE/DTLS） | ✅ 完成 | 2026-06 |
| Phase 2: 视频传输 | ✅ 完成 | 2026-06 |
| Phase 3: 输入控制 | ✅ 完成 | 2026-06 |
| Phase 4: 客户端测试（TDD） | 🔄 进行中（54%）⭐ | 2026-06~07 |
| MVP: 远程桌面（macOS） | 📋 计划中 | 2026-07~08 |

> **当前重点**: 客户端 TDD 测试 — 3/14 组件已验证（ConfigRepository、SignalingService、WebSocketClient）。平均测试覆盖率：~77%。  
> 详见 [测试文档](client/flutter/test/README.md)。

### 文档导航

- **[MVP 定义](docs/MVP.md)** — 我们在做什么，什么时候完成
- **[当前阶段](docs/CURRENT_PHASE.md)** — 我们现在在哪里
- **[E2E 测试方案](docs/E2E_TEST_PLAN.md)** — 端到端测试策略
- [文档索引](docs/README.md) — 完整文档导航
- [项目结构](PROJECT_STRUCTURE.md) — 项目组织和目录结构
