...
| Phase 2: Video Streaming | 🔄 In Progress (95%) ⭐ | Jun 2026 |
| Phase 3: Input Control | 📋 Planned | Jul 2026 |
| MVP: Remote Desktop (macOS) | 📋 Planned | Jul-Aug 2026 |

> **Current focus**: End-to-end video streaming pipeline complete! SDL2 display implemented. Testing phase.  
> See [Current Phase](docs/CURRENT_PHASE.md) for details.
...
| Phase 2: 视频传输 | 🔄 进行中（95%）⭐ | 2026-06 |
| Phase 3: 输入控制 | 📋 计划中 | 2026-07 |
| MVP: 远程桌面（macOS） | 📋 计划中 | 2026-07~08 |

> **当前重点**: 端到端视频流管道完成！SDL2 显示模块已实现。进入测试阶段。  
> 详见 [当前阶段](docs/CURRENT_PHASE.md)。
